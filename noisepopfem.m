...
title(['Single Females with px(0) = ' num2str(px0) ', x(0) = ' num2str(x0) ', y(0) = ' num2str(y0) ' for ' num2str(c) ' generations with noises epsilon1=' num2str(epsilon1) ', epsilon2=' num2str(epsilon2) ' and epsilon3=' num2str(epsilon3) '.'])
...
plot(time,propx3,'cs:');
xlabel('Time');
ylabel('Single Females Proportion');
title(['Single Females with px(0) = ' num2str(px0) ', x(0) = ' num2str(x0) ', y(0) = ' num2str(y0) ' for ' num2str(c) ' generations with noises epsilon1=' num2str(epsilon1) ', epsilon2=' num2str(epsilon2) ' and epsilon3=' num2str(epsilon3) '.'])
legend('epsilon=0', 'epsilon1', 'epsilon2', 'epsilon3')
hold off