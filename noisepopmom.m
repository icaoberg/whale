...
%This program generates individuals proportions and whale population size

function noisepopmom(epsilon1,epsilon2,epsilon3,px0,x0,y0,c)
...
plot(time,px3,'cs:');
xlabel('Time');
ylabel('Paired Mothers');
title(['Paired Mothers with px(0) = ' num2str(px0) ', x(0) = ' num2str(x0) ', y(0) = ' num2str(y0) ' for ' num2str(c) ' generations with noises epsilon1=' num2str(epsilon1) ', epsilon2=' num2str(epsilon2) ' and epsilon3=' num2str(epsilon3) '.'])
...
plot(time,propx3,'cs:');
xlabel('Time');
ylabel('Paired Mothers Proportion');
title(['Paired Mothers with px(0) = ' num2str(px0) ', x(0) = ' num2str(x0) ', y(0) = ' num2str(y0) ' for ' num2str(c) ' generations with noises epsilon1=' num2str(epsilon1) ', epsilon2=' num2str(epsilon2) ' and epsilon3=' num2str(epsilon3) '.'])
legend('epsilon=0', 'epsilon1', 'epsilon2', 'epsilon3')
hold off