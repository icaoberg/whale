...
function whale( epsilon, muj, mux, muy, px0, x0, y0, k )
...
title(['Px(0) = ' num2str(px0) ', x(0) = ' num2str(x0) ', y(0) = ' num2str(y0) '.'])
...
xlabel('Time')
ylabel('Single Females')
title(['p(0) = ' num2str(px0) ', x(0) = ' num2str(x0) ', y(0) = ' num2str(y0) '.'])
...
legend([num2str(propx(c-1))],[num2str(propy(c-1))],[num2str(propp(c-1))])
hold off