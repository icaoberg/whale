...
function whaleosc( epsilon, muj, mux, muy, px0, x0, y0, k )
...
for t = 12:c %Counter for number of generations
    x(t) = x_fosc( epsilon, betax, mux, muj, muy, x(t-1), y(t-1), px(t-1), px(t-k), k, t ); 
    y(t) = y_f( betay, mux, muy, y(t-1), px(t-k) );
    px(t) = px_fosc( epsilon, muj, mux, muy, x(t-1), y(t-1), t );
